...
<html class="no-js" lang="">
    <head>
        ...
        <title>Disclaimer || Igaaza Creations</title>
				...
				<div class="row">
					<div class="col-md-12">
					    <div class="breadcrumbs">
					        <h2 style="font-family: 'Sniglet', cursive;color: #00cbc9;">Disclaimer</h2> 
       ...
       <div class="online-banner-area">
		    <div class="container">
		        <div class="banner-title text-center">
		            <h2>DISCLAIMER OF CONDITIONS, WARRANTIES AND LIMITATION OF LIABILITY</h2>
		           <p class="tm-text"  style="text-align:Center; Padding:10px;text-align:justify;text-justify:inter-word;">SUBJECT TO THE UGANDAN LAW, igaaza.com DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE. Igaaza Creations LTD FURTHER DOES NOT WARRANT THAT THE Igaaza Creations LTD SERVICES THROUGH ITS igaaza.com SITE SUCH AS, INFORMATION, CONTENT, MATERIALS, PRODUCTS OR OTHER SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE igaaza.com SITE, ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.</br>
											THE SERVICE, CONTENT, GOODS AND SERVICES FROM OR THROUGH THE SERVICE ARE PROVIDED "AS-IS," "AS AVAILABLE," AND ALL WARRANTIES, EXPRESS OR IMPLIED, ARE DISCLAIMED (INCLUDING BUT NOT LIMITED TO THE DISCLAIMER OF ANY IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE). THE SOLE AND ENTIRE MAXIMUM LIABILITY OF COMPANY, FOR ANY REASON, AND BUYER'S SOLE AND EXCLUSIVE REMEDY FOR ANY CAUSE WHATSOEVER, SHALL BE LIMITED TO THE AMOUNT PAID BY THE CUSTOMER FOR THE PARTICULAR ITEMS PURCHASED. COMPANY AND ANY OF ITS AFFILIATES, DEALERS OR SUPPLIERS ARE NOT LIABLE FOR ANY INDIRECT, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES (INCLUDING DAMAGES FOR LOSS OF BUSINESS, LOSS OF PROFITS, LITIGATION, OR THE LIKE), WHETHER BASED ON BREACH OF AGREEMENT, BREACH OF WARRANTY, TORT (INCLUDING NEGLIGENCE), PRODUCT LIABILITY OR OTHERWISE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. THE LIMITATIONS OF DAMAGES SET FORTH ABOVE ARE FUNDAMENTAL ELEMENTS OF THE BASIS OF THE BARGAIN BETWEEN COMPANY AND BUYER. THIS igaaza.com SITE AND GOODS AND SERVICES WOULD NOT BE PROVIDED WITHOUT SUCH LIMITATIONS.</br>
											Igaaza Creations LTD WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND WHATSOVER ARISING FROM THE USE OF THE igaaza.com SITE AND ITS SERVICE THEREIN, OR FROM ANY INFORMATION, CONTENT, MATERIALS, PRODUCTS INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE igaaza.com SITE, INCLUDING, BUT NOT LIMITED TO DIRECT, INDIRECT, INCIDENTAL, PUNITIVE, AND CONSEQUENTIAL DAMAGES, OR AS MAY BE SPECIFIED UNDER THIS AGREEMENT.
											</p>
