...
<html class="no-js" lang="">
    <head>
        ...
        <title>Thank you || Igaaza Creations</title>
	...
	require_once('connect.php');
	$query2 = "Update`bookings` Set TransactionID='".$transactionid."' where OrderCode='".$referencenumber."'";
		...
		<div class="contact-form-area">
			<div class="container">
				...
				<div class="row">
						...
						<div style="width:50%; text-align:center; margin: 0 auto;"><div><h2>Thank you</h2></div></div>
								<blockquote>
                                   <div style="width:50%; text-align:center; margin: 0 auto;color: #33acff;"><div> <p>
                                        Thank you, your receipt of payment has been sent to your email. You will be contacted shortly for Delivery Details
                                    </p></div></div>
                                    <cite>
                                         <div style="width:50%; text-align:center; margin: 0 auto;"><div><a href="index.php">Back to Home Page</a></div></div>
                                    </cite>
                                </blockquote>
				</div>
			</div>
