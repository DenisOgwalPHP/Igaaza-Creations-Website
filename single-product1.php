                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-5">
                        <div class="single-product-details">
							...
							<Form method="GET" action="addtocart2.php">
		                    ...
		                    <div class="footer-left">
		                        ...
		                        <ul class="footer-contact">
		                            <li>
		                                ...
		                                Kanjokya Street, Kamwokya Uganda.
		                            </li>
		                            <li>
		            ...
		            <div class="row">
		                <div class="col-md-6">
                            <div class="footer-bottom-left pull-left">
                                <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> <span><a href="http://essentialsystems.atwebpages.com">Eng. Denis Ogwal</a></span>. All Right Reserved.</p>
                            </div>
		                </div>
		                <div class="col-md-6">
