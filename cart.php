...
<html class="no-js" lang="">
    <head>
        ...
        <title>Shopping Cart || Igaaza Creations</title>
    ...
    <body>
								...
								while($row8=mysqli_fetch_assoc($result8)){
                                    ...
                                    echo"<tr>";
										...
										echo"<td class='product-edit'>";
                                            echo"<p>";
                                                echo"<button class='cart-btn btn-default' name='updates' id='updates' value='".$row8['IDs']."' >UPDATE</button>";
                                            echo"</p>";
                                        echo"</td>";
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="discount-main-area">
                           ...
                           <button class='cart-btn btn-default' name="discountcode" id="discountcode" value="submit" style="margin:20px;" >APPLY COUPON</button> 
							</div>
							</form>
                            </div>
                        </div>
						...
						echo'alert("Unknown Coupon Code");';
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="subtotal-main-area" style="">
                            <div class="subtotal-area">
                                <h2>SUBTOTAL<span><?php
				if(isset($_SESSION['igaazauser'])){
				require_once('connect.php');					
				$sales11 ="SELECT SUM(Cost) as Carttotal from carttemporary where User='".$_SESSION['igaazaemail']."' and AddTo='Cart'";
				$results=mysqli_query($link,$sales11);
			...
			<div class="subtotal-area">
			   ...
			   Shs. 0
				...
				?></span></h2>
							...
							<div style="text-align:right; width:95%;">
							<form method='GET'>
                           <button class='cart-btn btn-default' name="finalsubmission" id="finalsubmission" value="submit" style="margin:20px;" >PROCEED TO CHECKOUT</button>
                            </form>
							</div>
		...
		<?php
				...
				require_once('connect.php');				
				$sales11 ="UPDATE carttemporary SET Quantity='$quantityss',Cost='$costss' WHERE IDs='".$id."' and User='".$_SESSION['igaazaemail']."'";
				$results=mysqli_query($link,$sales11);
				if($results)
				{
				echo '<script type="application/javascript">';
...
//session_start();
				...
				$sales6 ="SELECT User,Product,Quantity,Cost,ProductID FROM `carttemporary` where User='".$_SESSION['igaazaemail']."' and AddTo='Cart' ";
				...
				$sales7 ="DELETE  FROM carttemporary where User='".$_SESSION['igaazaemail']."' and AddTo='Cart'";
